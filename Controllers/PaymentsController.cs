...
//    /// Trả về paymentUrl để client redirect.
//    /// </summary>
...
//    /// <summary>
//    /// IPN callback — VNPay gọi server-to-server.
...
//    /// Chỉ hiển thị kết quả, KHÔNG cập nhật DB (dùng IPN cho việc đó).
//    /// </summary>
...
//    /// <summary>
//    /// Tạo URL thanh toán MoMo cho booking.
...
//    {
//        // Đọc các field từ JSON body MoMo gửi về
...
//        await _paymentService.RecordOnlinePaymentAsync(
//            bookingId, amountDecimal, methodId: 4 /* MoMo */, transId);
